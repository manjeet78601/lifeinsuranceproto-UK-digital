export class CompareQuotesConstant {
    ...
    public static HEALTH_HEADER = 'Compare Quotes';
    public static HEALTH_SUB_HEADER = 'Answer a few health Q’s';
    public static HEALTH_LINE = 'In order to provide you with quotes, we need to ask a few questions about your health.';
